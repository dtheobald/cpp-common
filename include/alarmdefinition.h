...
// "New in CCv7" alarm IDs moved out of logical sequence for compatibility with
// CCv8.
//
// If adding new alarm IDs and CCv8 not yet released, clear ID assignment with
// PC/CC to ensure no clash.

    ETCD_CLUSTERING_TAKING_TOO_LONG = 8000,
    CHRONOS_NOT_YET_CLUSTERED,
    MEMCACHED_NOT_YET_CLUSTERED,
    CASSANDRA_NOT_YET_CLUSTERED,
    CASSANDRA_NOT_YET_DECOMMISSIONED,

    ETCD_NO_SHARED_CONFIG = 8500,
  };
